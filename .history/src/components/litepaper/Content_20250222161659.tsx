...
function renderLine(line: string, key: number) {
  ...
  // Insert hyperlink if the line contains the specific phrase
  if (trimmed.includes("View the cognitive hierarchy here")) {
    const parts = trimmed.split("View the cognitive hierarchy here");
    return (
      <div key={key} className="text-gray-700">
        ...
        >
          View the cognitive hierarchy here
        </a>
        {parts[1]}
      </div>
    );
