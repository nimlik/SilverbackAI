...
function renderLine(line: string, key: number) {
  ...
  // Enhanced heading detection with flexible spacing
  ...
  // Existing bullet/list formatting
  if (trimmed.startsWith("* ")) {
    return (
  ...
  if (trimmed === "") {
    return <div key={key} className="h-2" />; // Changed from pb-2 to h-2
  }
  return (
...
export default function LitepaperContent() {
  ...
  // Lines array remains unchanged
  const lines = [
    "## Table of Contents",
    // ... rest of the original content array
    "## Table of Contents",
    "1. Introduction",
